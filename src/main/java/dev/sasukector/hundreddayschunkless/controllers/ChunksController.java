...
public class ChunksController {
    ...
    public void deleteChunks() {
        ...
        if (overworld != null) {
            ...
            if (chunkPorBorrar.size() > 0) {
                AtomicInteger chunkX = new AtomicInteger(chunkPorBorrar.get(0)[0]);
                AtomicInteger chunkZ = new AtomicInteger(chunkPorBorrar.get(0)[1]);
